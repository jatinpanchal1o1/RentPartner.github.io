...
export default function BookingForm(){
 ...
 return <form className="form card" onSubmit={submit}>
  ...
  <div className="form-section"><h3>Preferences</h3><Field label="Partner preference"><select name="preference" value={form.preference} onChange={upd}><option>Male</option><option>Female</option><option>No Preference</option></select></Field><Field label="Special requirements / message"><textarea name="message" value={form.message} onChange={upd} rows="4" placeholder="Tell us anything important about the request..."/></Field></div>
